                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
					            ...
					            <li><a href="<?php echo U('Admin/LogMoneys/index');?>" target='pageContent' >资金流水</a></li>
					            <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                            	<?php if(in_array('fxgl_01',$WST_STAFF['grant'])){ ?>
                            	<li><a href="<?php echo U('Admin/Distributs/queryShops');?>" target='pageContent' >分销商家列表</a></li>
                            	<?php } ?>
                            	<?php if(in_array('fxgl_02',$WST_STAFF['grant'])){ ?>
                            	<li><a href="<?php echo U('Admin/Distributs/queryGoods');?>" target='pageContent' >分销商品列表</a></li>
                            	<?php } ?>
                            	<?php if(in_array('fxgl_03',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Admin/Distributs/queryMoneys');?>" target='pageContent' >佣金分成列表</a></li>
					            <?php } ?>
					            <?php if(in_array('fxgl_04',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Admin/Distributs/queryUsers');?>" target='pageContent'>推广用户列表</a></li>
					            <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
